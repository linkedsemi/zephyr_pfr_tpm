...
#define SPI_FILTER_INIT(inst)                                                                                                                                                                                                        \
    ...
    static struct linkedsemi_spi_filter_data linkedsemi_spi_filter_data_##inst = {                                                                                                                                                   \
        .fixed_cmd_tab = {                                                                                                                                                                                                           \
            ...
            IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, cmd_page_program_quad_address_quad_data), ([IDX_CMD_PAGE_PROGRAM_QUAD_ADDR_QUAD_DATA] = DT_INST_PROP(inst, cmd_page_program_quad_address_quad_data), ))                           \
            ...
            IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, cmd_read_quad_address_quad_data), ([IDX_CMD_READ_QUAD_ADDR_QUAD_DATA] = DT_INST_PROP(inst, cmd_read_quad_address_quad_data), ))                                                   \
            ...
            IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, cmd_4byte_page_program_quad_address_quad_data), ([IDX_CMD_4BYTE_PAGE_PROGRAM_QUAD_ADDR_QUAD_DATA] = DT_INST_PROP(inst, cmd_4byte_page_program_quad_address_quad_data), ))         \
            ...
            IF_ENABLED(DT_INST_NODE_HAS_PROP(inst, cmd_4byte_read_quad_address_quad_data), ([IDX_CMD_4BYTE_READ_QUAD_ADDR_QUAD_DATA] = DT_INST_PROP(inst, cmd_4byte_read_quad_address_quad_data), ))                                 \
